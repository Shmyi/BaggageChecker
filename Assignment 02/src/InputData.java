...
public class InputData {
	...
	private static final String POSITIVE_MESSAGE = "Invalid data type. Please re-enter a positive value: ";
		...
		while(inputIsInvalid) {
			if(inputStream.hasNextInt()) {         // is data type good?
				...
				inputIsInvalid = false; // ...and break out on next loop
					...
					System.out.print(POSITIVE_MESSAGE);// bad data type ask to re-enter
				}
			}
			else {
